...
import IndexLink from "../modules/IndexLink";
...
describe("An <IndexLink>", function () {
    ...
    render() {
      return (
        <div>
          <ul>
            <li>
              <IndexLink id="rootLink" to="/" activeClassName="active">
                root
              </IndexLink>
            </li>
            <li>
            ...
            <li>
              <Link
                id="specificProductLink"
                to="/website/products/15"
                activeClassName="active"
              >
                specific product
              </Link>
  ...
  describe("when linking to the overview", function () {
    it("is active and other routes are not", function () {
      render(<Router history={createHistory("/website")} routes={routes} />);
  ...
  describe("when linking to a specific product", function () {
    it("is active and it's parent is also active", function () {
      render(
        <Router
          history={createHistory("/website/products/15")}
          routes={routes}
        />
      );
      expect(document.querySelector("#rootLink").className).toEqual("");
